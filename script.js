...
const friendsData = {
    ...
    "yongjun": {
        name: "Yong Jun",
        role: "Tom",
        letter: "Hallooo YongJun, 你看起来真的很年轻 我经常一度认为你是Junior 结果你也是跟我们一起毕业了哈哈哈哈哈哈哈哈, 虽然脸很嫩 but 你真的是一个big brother 还要麻烦你做教会的人事物理 真的辛苦了!!! 之后不知道还有没有机会再见面 我去sarawak的时候 一定会去找你玩的 不然你去西马也可以 我也能带你走哈哈哈哈哈哈哈, 很可惜那么迟才熟起来 毕业过后记得要多联系哦!!",
    ...
    "jiayao": {
        name: "Jia Yao",
        role: "Tom",
        letter: "もしもし 你真的是一个超随心随性的人, 很多东西都是 okkk, 跟你们真的是超级放心的, but 讲话的太少了 啦 没什么得到跟你聊到天 可能还没找到我们共同的话题 有机会真的会很想跟你多讲话, 我很想念你之前烫过的头发 真的很好看 不知道为什么现在没有了 but 我感觉你带眼镜会很有feel 你可以trytry看. 我们来不及熟了啦 那就祝你intern顺利 然后找到男朋友 记得要po出来 我很想吃你撒的狗粮的!!!",
    ...
    "yanyan": {
        name: "Yan Yan",
        role: "Tom",
        letter: "Yoo 竟然是YanYan欸, 要毕业了哈 CCMC又在失去一个领唱了 妳要ShinRou怎么活啊哈哈哈哈 都没有什么跟妳聊到天 but 我感觉妳真的是超好的一个人, 很喜欢作弄妳 因为妳真的很kawaii的说 应该是 妳跟ShinRou太多了哈哈哈哈哈, 以后不要在用鄙视的眼神看着了 我真的会takut啊哈哈哈哈 记得多po story欸 不然都不知道妳过得好不好了 so 毕业过后要好好的哦 想念我们的话就回来CCMC找ShinRou就好 因为我在penang intern 所以应该很难再见到了...",
...
// ==========================================
// 4. 拦截留言提交 -> 异步上传至你的专属 Google 表格数据库 (无刷新) [1.1.2]
// ==========================================
